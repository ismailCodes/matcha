...
function NotificationModal({ notificationModalOpen, notificationModalVariants }) {
  return (
    <motion.div
      className={`w-screen z-50 bg-gray-50 rounded-xl fixed top-14 right-0 flex flex-col justify-center py-4 px-2 overflow-scroll ${
